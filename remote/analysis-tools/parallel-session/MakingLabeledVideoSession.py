...
def MakingLabeledVideoSession(video_dir):
    """
    DeepLabCut Toolbox
    ...
    python3 MakingLabeledVideoSession.py video_dir

    Note: run python3 AnalyzeVideosSession.py video_dir first.
    ...
    # parser.add_argument("--video_dir", help="directory of this session of video")
    # parser.parse_args()
    # video_dir = args.video_dir

    print('MakingLabeledVideoSession called with directory ' + video_dir)
...
if __name__ == '__main__':
    ...
    if os.path.isdir(sys.argv[1]):
        MakingLabeledVideoSession(sys.argv[1])
    else:
        raise('Invalid file specified. Usage: python MakingLabeledVideoSession.py video_dir')
